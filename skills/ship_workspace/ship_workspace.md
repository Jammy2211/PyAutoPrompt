...
4. If smoke tests pass: create the PR with `gh pr create --repo <owner/repo> --head feature/<task-name> --label "pending-release" --title "<title>" --body "<body>"`, pasting the drafted body via HEREDOC.
